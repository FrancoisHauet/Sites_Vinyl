...
<head>
    ...
    <?php include_once("model/delete_request.php") ?>
...
<div class="container">
    <form id="contact" action="delete_vinyl.php" method="post">
    <center><h3>Supprimer un vinyle</h3>
        <h4>Veuillez remplir le formulaire pour ajouter supprimer</h4> </center>
        <fieldset>
        ...
        <fieldset>
            <input placeholder="Le pays du pressage de l'album (pas obligatoire)" name="country" type="text" value="<?php echo isset($_POST['country'])?htmlentities($_POST['country'],ENT_QUOTES,"UTF-8"):''; ?>">
        </fieldset>
        <fieldset>
